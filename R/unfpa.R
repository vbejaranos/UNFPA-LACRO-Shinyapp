...
ui <- fluidPage(
    ...
    sidebarLayout(
      ...
      sidebarPanel(
               # logo
               fluidRow(HTML('<center><a href="https://www.unfpa.org/es/node/23618" target="_blank"><img src="converge.png" style="max-width:45%;"></a></center>')),
               ...
               hr(style="background-color: #66A0C4;height: 3px;border-radius: 2px;margin-top:5px;margin-bottom:2px;"),
               # data links
               HTML('<p style="text-align:center;"><span><b>Data:</b></span><br/> XLSX <a class=iconlink href="https://github.com/vbejaranos/UNFPA-LACRO-Shinyapp/blob/main/Tablas.xlsx?raw=true" style="margin-right:5px;">',
               ...
               #logos
               fluidRow(align = "center",
                        a(href="https://covid19-map.unfpa.org/",img(src="unfpa.png", style="width:45%;", class="logo"),target="_blank", class="logo")
    ...
    mainPanel(
      ...
      fluidRow(align="center", 
               ...
               HTML("<span style='color:green;font-weight:bold;'> Public GitHub repository ", '<a class=iconlink href="https://github.com/vbejaranos/UNFPA-LACRO-Shinyapp" target="_blank">', as.character(icon("github", class="social")), "</a></span><br/>"),
